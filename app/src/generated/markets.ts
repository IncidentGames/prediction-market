...
export interface GetPaginatedMarketResponse {
    ...
    page: number;
    /**
     * @generated from protobuf field: uint64 page_size = 3;
     */
    pageSize: number;
    /**
     * @generated from protobuf field: uint64 total_items = 4;
     */
    totalItems: number;
    /**
     * @generated from protobuf field: uint64 total_pages = 5;
     */
    totalPages: number;
}
/**
...
class GetPaginatedMarketResponse$Type extends MessageType<GetPaginatedMarketResponse> {
    constructor() {
        super("markets.GetPaginatedMarketResponse", [
            ...
            { no: 2, name: "page", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "page_size", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 4, name: "total_items", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 5, name: "total_pages", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: GetPaginatedMarketResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint64 page = 2; */
        if (message.page !== 0)
            writer.tag(2, WireType.Varint).uint64(message.page);
        /* uint64 page_size = 3; */
        if (message.pageSize !== 0)
            writer.tag(3, WireType.Varint).uint64(message.pageSize);
        /* uint64 total_items = 4; */
        if (message.totalItems !== 0)
            writer.tag(4, WireType.Varint).uint64(message.totalItems);
        /* uint64 total_pages = 5; */
        if (message.totalPages !== 0)
            writer.tag(5, WireType.Varint).uint64(message.totalPages);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
