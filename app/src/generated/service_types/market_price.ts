...
export interface WsParamsPayload {
    ...
    marketId: string;
    /**
     * @generated from protobuf field: string yes_price = 2;
     */
    yesPrice: string;
    /**
     * @generated from protobuf field: string no_price = 3;
     */
    noPrice: string;
}
/**
...
class WsParamsPayload$Type extends MessageType<WsParamsPayload> {
    constructor() {
        super("ws_market_price.WsParamsPayload", [
            ...
            { no: 2, name: "yes_price", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "no_price", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string market_id */ 1:
                    ...
                    break;
                case /* string yes_price */ 2:
                    message.yesPrice = reader.string();
                    break;
                case /* string no_price */ 3:
                    message.noPrice = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: WsParamsPayload, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string yes_price = 2; */
        if (message.yesPrice !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.yesPrice);
        /* string no_price = 3; */
        if (message.noPrice !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.noPrice);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
